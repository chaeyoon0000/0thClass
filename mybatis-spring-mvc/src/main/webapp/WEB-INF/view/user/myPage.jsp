				...
				<div class="row">
					...
					<div class="col-md-12 col-lg-8 mb-5">
						<form action="#" class="p-5 bg-white">
							<h3 class="h5 text-black mb-3">My Information</h3>
							...
							<div class="row">
								<div class="col-2">
									<p class="mb-0 font-weight-bold">Points</p>
								</div>
								<div class="col-10">
									<p class="mb-4">${user.point}</p>
								</div>
							</div>
							...
							<div class="row form-group" style="text-align: right">
								<div class="col-md-12">
									<a class="btn btn-primary text-white px-4 py-2" href="<%=request.getContextPath()%>/user/editUserInfo.do" role="button">Edit</a>
									<a class="btn btn-primary text-white px-4 py-2" href="order.jsp" role="button">My Order</a>
								</div>
							</div>
						</form>
					</div>
