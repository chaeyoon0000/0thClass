			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-12 col-lg-10 mb-5">
						<form action="/mybatis-spring-mvc/review/insertNewComment.do/${notice.num}" class="p-5 bg-white">
							<p class="h5 text-black mb-3">Notice</p>
							
							<div class="row">
								<div class="col-9">
									<p class="mb-4">${notice.title}</p>
								</div>
							</div>
										...
										<c:forEach var="comment" items="${commentList}">
											<tr>
												...
												<c:if test="${sessionScope.user.id eq comment.uNum}"><a
													...
													href="/mybatis-spring-mvc/review/deleteComment.do/${notice.num}?cNum=${comment.cNum}"
						...
						<input type="hidden" name="num" value="${notice.num}"/>
							...
							<div class="row form-group" style="text-align: right">
								...
								<c:if test="${!empty page}">
									...
									<a class="btn btn-outline-primary px-4 py-2" href="/mybatis-spring-mvc/review/editNotice.do/${notice.num}" role="button">
										수정
									</a>
									<a class="btn btn-outline-primary px-4 py-2" href="/mybatis-spring-mvc/review/deleteNotice.do/${notice.num}" role="button">
										삭제
									</a>
									</c:if>
								</div>
