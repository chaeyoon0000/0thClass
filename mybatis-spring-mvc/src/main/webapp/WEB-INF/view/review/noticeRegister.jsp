				...
				<div class="row">
					...
					<div class="col-md-12 col-lg-10 mb-5">
						<c:if test="${!empty notice}">
							<form action="../insertEditNotice.do/${notice.num}" class="p-5 bg-white" method="post" enctype="multipart/form-data">
						</c:if>
						<c:if test="${empty notice}">
							<form action="insertNewNotice.do" class="p-5 bg-white" method="post" enctype="multipart/form-data">
						</c:if>
						<div class="row form-group">
							<div class="col-md-12 mb-3 mb-md-0">
								<label class="font-weight-bold" for="title">Notice Title</label>
								<c:if test="${!empty notice}">
						...
						<div class="row form-group">
							<div class="col-md-12 mb-3 mb-md-0">
								...
								<c:if test="${!empty notice}">
									<textarea id="content" class="form-co-*ntrol" name="content"
						...
						<input type="hidden" name="rNum" value="${notice.num}" />
