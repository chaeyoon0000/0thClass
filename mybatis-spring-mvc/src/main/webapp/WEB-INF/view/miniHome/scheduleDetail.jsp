						...
						<form action="#" class="p-5 bg-white">
							...
							<div class="row">
								...
								<div class="col-9">
									...
									<p class="mb-4"><c:out value="${schedule.team.tName}" /></p>

								</div>

								<div class="col-2" style="text-align: right;">

									<p class="mb-4"><c:out value="${schedule.mentor.name}" /></p>
							...
							<div class="row">
								...
								<div class="col-10">
									...
									<p class="mb-4"><c:out value="${schedule.schDate}" /></p>
							...
							<div class="row">
								...
								<div class="col-10">
									...
									<p class="mb-4"><c:out value="${schedule.schAddr}" /></p>
							...
							<p class="mb-4"><c:out value="${schedule.schContent}" /></p>
						...
						<div class="modal-dialog" role="document">
							...
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<a class="btn btn-primary" href="../miniHome.do/${schedule.team.tNum} " role="button">확인</a>
...
<!-- 									<a class="btn btn-outline-primary px-4 py-2" href="../" role="button"> -->
